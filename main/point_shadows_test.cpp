...
namespace gpr5300
{
	class point_shadows_test final : public Scene
	{
	public:
		void Begin() override;
	...
	void point_shadows_test::renderQuad()
	{
		if (quadVAO == 0)
		{
			float quadVertices[] = {
	...
	void point_shadows_test::renderCube()
	{
	...
	void point_shadows_test::renderScene(const Pipeline& shader)
	{
		// room cube
	...
	void point_shadows_test::Update(float dt)
	{
		...
		lightPos.z = static_cast<float>(std::sin(time_ * 0.5) * 3.0);
...
int main(int argc, char** argv)
{
	...
	gpr5300::point_shadows_test scene;
	scene.camera = &camera;
