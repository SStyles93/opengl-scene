...
namespace gpr5300
{
	class deferred_pbr_skybox_ssao_shadows : public Scene
	{
	public:
		void Begin() override;
	...
	void deferred_pbr_skybox_ssao_shadows::renderImage()
	{
		if (quadVAO == 0)
		{
			float quadVertices[] = {
	...
	void deferred_pbr_skybox_ssao_shadows::renderCube()
	{
	...
	float deferred_pbr_skybox_ssao_shadows::ourLerp(float a, float b, float f)
	{
		return a + f * (b - a);
	}

	void deferred_pbr_skybox_ssao_shadows::Begin()
	{
...
#pragma region Shader Loading
		...
		pipelines.emplace_back(
			...
			"data/shaders/deferred_pbr_skybox_ssao_shadows/g_buffer_inst2.frag");
		//Lighting pass 1
		pipelines.emplace_back(
			"data/shaders/deferred_pbr_skybox_ssao_shadows/deferred_shading_inst2.vert",
			"data/shaders/deferred_pbr_skybox_ssao_shadows/deferred_shading_inst2.frag");
		//Light Boxes 2
		pipelines.emplace_back(
			"data/shaders/deferred_pbr_skybox_ssao_shadows/deferred_light_box_inst2.vert",
			"data/shaders/deferred_pbr_skybox_ssao_shadows/deferred_light_box_inst2.frag");
		//Skybox 3
		pipelines.emplace_back(
...
#pragma endregion
	...
	void deferred_pbr_skybox_ssao_shadows::Update(float dt)
	{
		time_ += dt;
...
#pragma endregion
	...
	void deferred_pbr_skybox_ssao_shadows::End()
	{
...
int main(int argc, char** argv)
{
	...
	gpr5300::deferred_pbr_skybox_ssao_shadows scene;
	scene.camera = &camera;
