...
namespace gpr5300
{
    ...
    void blend_test::Begin()
    {
        ...
        // -------------------------
        shader = Pipeline("data/shaders/hello_model/model.vert", "data/shaders/stensil/stensil.frag");
        ...
        // load textures
        // -------------
        cubeTexture = LoadTexture("data/textures/container.jpg");
        floorTexture = LoadTexture("data/textures/container.jpg");
        transparentTexture = LoadTexture("data/textures/window.png");
